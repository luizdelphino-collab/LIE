...
import { LayoutDashboard, FileText, Package, Calendar, FolderOpen, ArrowLeft, Truck, ClipboardCheck } from 'lucide-react';

type Secao = 'visao' | 'plano' | 'itens' | 'cronograma' | 'execucao' | 'prestacao' | 'documentos';
...
const SECOES: { id: Secao; label: string; icon: typeof FileText; rota: (id: string) => string }[] = [
  ...
  { id: 'prestacao', label: 'Prestação de Contas', icon: ClipboardCheck, rota: id => `/projetos/${id}/prestacao` },
